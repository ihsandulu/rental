...
<div class='container-fluid'>
    <div class='row'>
        <div class='col-md-5 col-sm-12'>
            <div class="card" style="font-size: 20px; font-weight:bold; text-align:center;">.: Pencatatan Barang Masuk :.</div>
            <div class="card">
                                ...
                                <div class="modal-body">
                                    <div>
                                        <div class="form-group">
                                            <label for="user_id">NAMA:</label> &nbsp
                                                ...
                                                $(document).ready(function() {
                                                    $('#user_name').on('change', function() {
                                                        ...
                                                        if (selectedUser) {
                                                            ...
                                                            $("#user_id").val(0);
                                                            alert("Opsi tidak ditemukan atau input manual tanpa memilih dari daftar");
                                                        }
                                                    });
                                                });
                                            </script>
