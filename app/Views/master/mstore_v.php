...
<div class='container-fluid'>
                        ...
                        <div class="">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input required autofocus type="text"  class="form-control" id="store_name" name="store_name" placeholder="" value="<?= $store_name; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_address" name="store_address" placeholder="" value="<?= $store_address; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_owner" name="store_owner" placeholder="" value="<?= $store_owner; ?>">
                                    </div>
                                </div>

                                
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="store_notifurl">Notification URL:</label>
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_notifurl" name="store_notifurl" placeholder="" value="<?= $store_notifurl; ?>">
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_phone" name="store_phone" placeholder="" value="<?= $store_phone; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_wa" name="store_wa" placeholder="" value="<?= $store_wa; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"  class="form-control" id="store_web" name="store_web" placeholder="" value="<?= $store_web; ?>">
                                    </div>
                                </div>
 ...
 -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file"  class="form-control" id="store_picture" name="store_picture" placeholder="" value="<?= $store_picture; ?>">
